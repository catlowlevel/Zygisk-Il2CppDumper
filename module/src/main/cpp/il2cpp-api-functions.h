...
DO_API(void, il2cpp_native_stack_trace,
       (const Il2CppException *ex, uintptr_t **addresses, int *numFrames, char **imageUUID, char **imageName));
...
// liveness
DO_API(void *, il2cpp_unity_liveness_allocate_struct,
...
DO_API(void, il2cpp_profiler_install_gc,
...
DO_API(Il2CppObject *, il2cpp_runtime_invoke_convert_args,
       (const MethodInfo *method, void *obj, Il2CppObject **params, int paramCount, Il2CppException **exc));
